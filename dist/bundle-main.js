...
Lightbox.prototype = {
    ...
    do_inline_transforms: function do_inline_transforms(html) {
        ...
        while ((match = patt.exec(html)) != null) {
            var key = match[1];
            if (this.inline_transforms.hasOwnProperty(key)) this.inline_transforms[key](this, match[2]);
        }
    },
...
},{"./inline-transforms":1,"jquery":14,"jquery.transit":13,"mousetrap":15}],3:[function(require,module,exports){
'use strict';
...
},{"./../templates/lightbox.html":4,"./lightbox":2,"jquery":14}],4:[function(require,module,exports){
...
},{"handlebars/runtime":12}],5:[function(require,module,exports){
'use strict';
